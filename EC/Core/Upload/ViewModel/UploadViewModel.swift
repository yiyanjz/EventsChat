...
//  EC
//
//  Created by Justin Zhang on 11/7/23.
//
...
class UploadViewModel: ObservableObject {
    @Published var selectedFilter: UploadFilter = .allItems
    @Published var showMoreAblum: Bool = false
    ...
    @Published var previewPost: Bool = false
    @Published var completePost: Bool = false
    @Published var draggedItemSheet: LibrayPhotos?
    @Published var hasChangedLocationSheet: Bool = false
